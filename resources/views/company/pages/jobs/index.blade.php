                    ...
                    <tr class="hover:bg-indigo-50/30 transition-colors group {{ !$status['is_active'] ? 'opacity-60' : '' }}">
                        ...
                        <td class="px-6 py-5 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end items-center gap-2">
                                ...
                                <form action="{{ route('jobs.destroy', $item['lowongan_id']) }}" method="POST"
                                    class="inline-block"
                                    data-confirm="{{ e('Yakin ingin menghapus lowongan ' . ($item['judul'] ?? 'ini') . '? Tindakan ini tidak dapat dibatalkan.') }}"
