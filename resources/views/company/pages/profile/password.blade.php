...
<div class="space-y-6 max-w-3xl">
    ...
    <div class="bg-white border border-gray-100 rounded-3xl shadow-[0_4px_20px_-4px_rgba(6,81,237,0.05)] overflow-hidden">
        ...
        <form action="{{ route('company.password.update') }}" method="POST" class="p-6 sm:p-8 space-y-5">
            @csrf
            ...
            <div class="flex flex-col sm:flex-row sm:justify-end gap-3 pt-3">
                <a href="{{ route('company.profile') }}" class="inline-flex items-center justify-center px-4 py-2.5 rounded-xl border border-gray-200 bg-white text-sm font-semibold text-gray-600 hover:bg-gray-50 transition">
                    Batal
                </a>
