                ...
                <tbody class="divide-y divide-slate-200">
                    <tr class="hover:bg-slate-50 transition-colors">
                        <td class="px-6 py-4 border-b border-slate-100">
                            <div class="flex items-center gap-3">
                                <div class="h-8 w-8 rounded bg-slate-100 flex items-center justify-center text-slate-500 font-bold text-sm">TV</div>
                                <span class="font-medium text-slate-900">TechVision Inc.</span>
                            </div>
                        </td>
                        <td class="px-6 py-4 border-b border-slate-100 text-sm text-slate-600">contact@techvision.com</td>
                        <td class="px-6 py-4 border-b border-slate-100 text-sm text-slate-600">Oct 24, 2026</td>
                        <td class="px-6 py-4 border-b border-slate-100">
                        ...
                        <td class="px-6 py-4 border-b border-slate-100 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <button class="p-1.5 text-emerald-600 hover:bg-emerald-50 rounded-lg transition-colors" title="Approve">
                                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                    </svg>
                                </button>
                                <button class="p-1.5 text-rose-600 hover:bg-rose-50 rounded-lg transition-colors" title="Reject">
                                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        <td class="px-6 py-4 border-b border-slate-100">
                            <div class="flex items-center gap-3">
                                <div class="h-8 w-8 rounded bg-slate-100 flex items-center justify-center text-slate-500 font-bold text-sm">NS</div>
                                <span class="font-medium text-slate-900">Nexus Solutions</span>
                            </div>
                        </td>
                        <td class="px-6 py-4 border-b border-slate-100 text-sm text-slate-600">hr@nexussolutions.io</td>
                        <td class="px-6 py-4 border-b border-slate-100 text-sm text-slate-600">Oct 23, 2026</td>
                        <td class="px-6 py-4 border-b border-slate-100">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-800">
                                Pending
                            </span>
