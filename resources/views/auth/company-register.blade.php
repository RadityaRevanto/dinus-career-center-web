...
<body class="min-h-screen flex items-center justify-center bg-[#e6ebf5] font-[Poppins]"
      x-data="{ step:1, registered:false }">
...
<div class="w-[95%] max-w-[1600px] min-h-[820px]
    ...
    <div class="w-full md:w-1/2 relative flex flex-col items-center justify-center px-16">
            ...
            <div class="absolute top-10 left-12 flex gap-2"
            ...
            <!-- FORM WRAPPER -->
        <div class="relative w-full max-w-xl py-10"
                x-show="!registered" x-cloak>
            ...
            <!-- FORM -->
<form @submit.prevent="if(step===4) registered=true" class="space-y-7">
...
<div x-show="step===2" class="space-y-5">
    ...
    <div class="relative group">
        ...
        <input type="text" placeholder="Industri"
            class="w-full pl-12 pr-4 py-4 rounded-xl border border-slate-300 text-sm
            focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
    </div>
    ...
    <div class="relative group">
        <i data-lucide="file-text"
           class="w-5 h-5 text-slate-400 absolute left-4 top-5"></i>

        <textarea rows="3" placeholder="Deskripsi"
            class="w-full pl-12 pr-4 py-4 rounded-xl border border-slate-300 text-sm
            focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"></textarea>
    </div>
...
<div x-show="step===3" class="space-y-5">
    ...
    <div class="relative group">
        ...
        <textarea rows="2" placeholder="Alamat"
            class="w-full pl-12 pr-4 py-4 rounded-xl border border-slate-300 text-sm
            focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"></textarea>
    </div>
...
<button type="button" x-show="step>1"
    ...
    <button type="submit" x-show="step===4"
        ...
        <div x-show="registered" x-cloak
            ...
            <div class="mx-auto w-20 h-20 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center shadow-lg shadow-emerald-500/30 mb-6">
            ...
            <p class="text-slate-400 mt-3 text-sm leading-relaxed max-w-sm mx-auto">Akun perusahaan Anda sedang diverifikasi oleh admin. Kami akan menghubungi Anda melalui email.</p>
            ...
            <a href="/login"
               class="mt-8 inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-3 rounded-xl font-semibold text-sm hover:from-blue-500 hover:to-indigo-500 shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 transition-all duration-200 hover:scale-[1.02]">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"/></svg>
                Kembali ke Login
            </a>
        </div>
